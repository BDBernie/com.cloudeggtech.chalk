package com.cloudeggtech.chalk.core.stream.negotiants.tls;
...
import com.cloudeggtech.basalt.protocol.core.stream.tls.Failure;
import com.cloudeggtech.basalt.protocol.core.stream.tls.Proceed;
...
import com.cloudeggtech.basalt.protocol.oxm.translators.core.stream.tls.StartTlsTranslatorFactory;
...
public class TlsNegotiant extends InitialStreamNegotiant {
	protected static final int DEFAULT_TLS_PROCESS_TIMEOUT = 1000 * 5;
