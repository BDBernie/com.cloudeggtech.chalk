...
import com.cloudeggtech.chalk.network.SocketConnection;
...
public abstract class AbstractStreamer implements IStreamer, IConnectionListener {
	...
	public AbstractStreamer(StreamConfig streamConfig, IConnection connection) {
		...
		parsingFactory.register(ProtocolChain.first(com.cloudeggtech.basalt.protocol.core.stream.Stream.PROTOCOL),
