...
import com.cloudeggtech.chalk.network.ConnectionException.Type;
...
public class Stream implements IStream, IConnectionListener {
	...
	private class MessageProcessingThread implements Runnable {
		...
		public void run() {
			...
			} else if (object instanceof com.cloudeggtech.basalt.protocol.core.stream.Stream) {
				com.cloudeggtech.basalt.protocol.core.stream.Stream closeStream =
					(com.cloudeggtech.basalt.protocol.core.stream.Stream)object;
